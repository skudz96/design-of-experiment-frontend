...
function generateDesignMatrix(factors, levels, halfFactorial) {
  // Check if the criteria are met
  if (levels.length > 3 || factors > 6 || factors * levels.length > 15) {
    return "Error: Exceeds the limit of 3 levels, 6 factors, and 15 repeats.";
  }
  let arrays;
  ...
  let matrix = fastCartesian(arrays);
